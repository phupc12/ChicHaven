            ...
            <div class="row">
                <?php
                    ...
                    echo '<div style="margin-top: -45px;" class="col-md-6">
							...
							<form method="POST" action="index.php?act=cart"> <!-- Thay đổi action thành cart.php -->
                                ...
                                <button style="background-color: #007bff; border: none; padding: 10px 20px; font-size: 18px; transition: background-color 0.3s; font-weight:normal; border-radius: 5px;" class="btn btn-primary hover" type="submit">Thêm vào giỏ hàng</button>
							</form>
                            </div>';
                ?>
                <!-- <div class="col-md-6">
